  ...
  return (
    <section>
      ...
      <div className="relative w-full h-screen md:max-w-5xl xl:max-w-7xl mx-auto mt-36 px-9">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-4 md:gap-4 font-light">
          ...
          <div className="col-span-1 md:col-span-2 text-right pl-0 md:pl-28 md:flex md:items-center">
            <p>
          ...
          <div className="col-span-1 md:col-span-2 pr-0 md:pr-28 md:flex md:items-center">
            <p>
