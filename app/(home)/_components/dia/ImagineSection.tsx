...
export default function DreamSection() {
  const imagineSectionRef = useRef(null);
  const imaginePlaceholderRef = useRef(null);
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const dreamRGB = hexToRgbArray(diaPhases[1].color);
      const imagineRGB = hexToRgbArray(diaPhases[2].color);
      ...
      gsap.fromTo(
        ...
        { r: dreamRGB[0], g: dreamRGB[1], b: dreamRGB[2] },
        {
          ...
          b: imagineRGB[2],
          scrollTrigger: {
            trigger: imaginePlaceholderRef.current,
            start: 'top top',
            end: 'bottom bottom',
            scrub: true,
          },
  ...
  return (
    <section
      ...
      <div ref={imaginePlaceholderRef} className="h-min-[200vh]"></div>
    </section>
  );
}
